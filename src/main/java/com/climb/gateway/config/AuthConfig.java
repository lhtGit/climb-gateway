...
public class AuthConfig  {
     ...
     */
    private List<ResourceInfo> getPermit(){
        return  Lists.newArrayList(
                new ResourceInfo("","swagger","/doc.html",HttpMethod.GET.name()),
                new ResourceInfo("","js","/webjars/**",HttpMethod.GET.name()),
                new ResourceInfo("","swagger-ui","/swagger-resources/**",HttpMethod.GET.name()),
                new ResourceInfo("","swagger","/swagger-resources",HttpMethod.GET.name()),
                new ResourceInfo("","swagger-doc-api","/*/*/v2/api-docs",HttpMethod.GET.name()),
                new ResourceInfo("","ico","/*.ico",HttpMethod.GET.name()),
                new ResourceInfo("","登录",LOGIN_PAGE,HttpMethod.POST.name()),
                new ResourceInfo("","刷新token","/refresh/token",HttpMethod.POST.name())
        );
